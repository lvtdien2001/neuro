  ...
  return (
    ...
    >
      <div
        ...
        } rounded border-2 w-full h-full p-4`}
      >
...
const Header: React.FC<PhaseProps> = ({ children, className }) => {
  return <div className={`${className} grid grid-cols-2 mb-5`}>{children}</div>;
};
...
const Text: React.FC<PhaseProps> = ({ children, className }) => {
  return <div className={`${className} font-content`}>{children}</div>;
};
