...
export const ButtonAccent: React.FC<ButtonAccentProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`${
          isHover ? 'bg-[#FF3D00]' : 'bg-[#131316]'
        } px-12 py-2 shadow-[0_12px_24px_-8px_rgba(0,0,0,0.24)] rounded-[32px] overflow-hidden border-2 border-[#FF3D00] border-solid justify-center items-center gap-2 inline-flex`}
      >
